...
import huce.cntt.oop.doan.service.DiemLopHocPhanService;
...
public class DiemLopHocPhanController {
    ...
    private final DiemLopHocPhanService diemLopHocPhanService = DiemLopHocPhanService.getInstance();
    ...
    public void initialize(){
        ...
        List<DiemLopHocPhan> diem = diemLopHocPhanService.layTatCaDiem();
        ...
        //                     searchResults = diemLopHocPhanService.layDiemLopHPTheoMaMon(maMon);
        ...
        //             case "Tên môn":
        //             try {
        //                 searchResults = diemLopHocPhanService.layDiemLopHPTheoTenMon(searchText, searchOption2);
        //             } catch (Exception e) {
        //                 e.printStackTrace();
    ...
    public void setItemsForChoiceBox(String tenMon) {
        List<DiemLopHocPhan> danhSachLopHP = diemLopHocPhanService.layDanhSachLopHPTheoMon(tenMon);
    ...
    private void xoa() {
        ...
        if (confirm.isPresent() && confirm.get() == ButtonType.OK) {
            try {
                boolean xoaThanhCong = diemLopHocPhanService.xoa(diem.getMaLopHP(), diem.getMSSV());
