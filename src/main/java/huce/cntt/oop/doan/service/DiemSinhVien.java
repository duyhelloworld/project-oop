...
public class DiemSinhVien {
    ...
    public List<Map<String, String>> laySinhVienTheoLopQuanLi(String tenLop) {
        String query = "SELECT SinhVien.mssv, ho_ten, SinhVien.ten_lop AS lop_quan_li, TinhDiem.ten_lop AS lop_mon_hoc, MonHoc.ten AS ten_mon_hoc, khoa, diem_chuyen_can, diem_giua_ki, diem_cuoi_ki"
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                row.put("diem_chuyen_can", Integer.toString(resultSet.getInt("diem_chuyen_can")));
    ...
    public List<Map<String, String>> laySinhVienTheoLopMonHoc(String tenLop) {
        String query = "SELECT SinhVien.mssv, ho_ten, SinhVien.ten_lop AS lop_quan_li, LopMonHoc.ten_lop AS lop_mon_hoc, LopQuanLi.khoa, diem_chuyen_can, diem_giua_ki, diem_cuoi_ki"
